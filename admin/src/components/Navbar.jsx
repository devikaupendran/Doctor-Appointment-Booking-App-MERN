    ...
    return (
        <div className='flex justify-between items-center px-4 sm:px-10 py-3 border-b border-b-zinc-300 bg-white'>
            <div className='flex items-center gap-2 text-xs'>
                ...
                <p className='border border-gray-500 text-gray-600 px-2.5 py-.5 rounded-full cursor-pointer'>{admintoken ? 'Admin' : 'Doctor'}</p>
            </div>
            <button className='bg-blue-500 text-white text-sm px-10 py-2 rounded-full cursor-pointer' onClick={logout}>Logout</button>
        </div>
    )
}
